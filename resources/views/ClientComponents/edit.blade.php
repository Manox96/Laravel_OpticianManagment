                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('client.update',$client) }}" class="space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <input value="{{$client->nom}}" type="text" name="nom" id="nom" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        </div>
                        <div class="space-y-2">
